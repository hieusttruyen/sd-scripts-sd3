...
def load_models(
    ...
    print(f"Loading SD3 models from {ckpt_path}...")
    state_dict = load_state_dict(ckpt_path)

    # load clip_l
    clip_l_sd = None
    if clip_l_path:
        print(f"Loading clip_l from {clip_l_path}...")
    ...
    clip_g_sd = None
    if clip_g_path:
        print(f"Loading clip_g from {clip_g_path}...")
    ...
    t5xxl_sd = None
    if t5xxl_path:
        print(f"Loading t5xxl from {t5xxl_path}...")
